...
/** Wi-Fi AP Settings. */
#define MAIN_WLAN_SSID "Arrakis"             /**< Destination SSID. Change to your WIFI SSID */
#define MAIN_WLAN_AUTH M2M_WIFI_SEC_WPA_PSK /**< Security manner */
#define MAIN_WLAN_PSK "fourwordsalluppercase"            /**< Password for Destination SSID. Change to your password. Please dont hack my WiFi router */
...
// Structure to hold humidity data
struct HumidityPacket {
	uint16_t humidity;
...
#define TEMP_TOPIC "TEMP_ESE516_T3"			//Temperature data topic to send to nodered
#define HUMID_TOPIC "HUMID_ESE516_T3"		//Humidity data topic to send to nodered
